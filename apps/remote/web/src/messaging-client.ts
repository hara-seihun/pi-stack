...
import type { MessagingAttachment, MessagingCall, MessagingConversation, MessagingHistory, MessagingLink, MessagingMessage, MessagingResult, MessagingSend } from "../../server/messaging/protocol";
